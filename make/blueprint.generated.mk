...
.PHONY: help \
  ...
  infra-runtime-inventory infra-local-runtime-inventory infra-stackit-runtime-prerequisites infra-stackit-runtime-inventory infra-stackit-runtime-deploy \
...
blueprint-upgrade-consumer-finalize: ## Run post-upgrade quality convergence: sync pass (aggregated) then verify pass (fail-fast)
	@scripts/bin/blueprint/upgrade_consumer_finalize.sh
...
blueprint-install-codex-skill-sdd-step02-resolve-questions: ## Install/sync bundled Codex SDD step02-resolve-questions skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step02-resolve-questions

blueprint-install-codex-skill-sdd-step03-spec-complete: ## Install/sync bundled Codex SDD step03-spec-complete skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step03-spec-complete

blueprint-install-codex-skill-sdd-step04-plan-slicer: ## Install/sync bundled Codex SDD step04-plan-slicer skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step04-plan-slicer

blueprint-install-codex-skill-sdd-step05-implement: ## Install/sync bundled Codex SDD step05-implement skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step05-implement

blueprint-install-codex-skill-sdd-step06-document-sync: ## Install/sync bundled Codex SDD step06-document-sync skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step06-document-sync

blueprint-install-codex-skill-sdd-step07-pr-packager: ## Install/sync bundled Codex SDD step07-pr-packager skill into local CODEX_HOME skills directory
	@scripts/bin/blueprint/install_codex_skill.sh --skill-name blueprint-sdd-step07-pr-packager
...
quality-workaround-manifest-check: ## Fail when workaround manifest action_path entries reference missing files
	@uv run python3 scripts/bin/quality/check_workaround_manifest.py
...
quality-pr-commit-autoclose-check: ## Scan PR title/body and branch commits for auto-close keywords targeting must-not-auto-close issues
	@uv run python3 scripts/bin/quality/check_pr_commit_autoclose.py
...
quality-ci-fast: ## Run canonical fast CI lane bundle
	...
	@$(MAKE) quality-runtime-contract-drift-report
...
quality-docs-cross-reference-check: ## Detect heading duplication between AGENTS.md and north_star.md
	@uv run python3 scripts/bin/quality/check_docs_cross_reference.py

quality-docs-agents-md-structure-check: ## Verify AGENTS.md contains required structural elements for north_star.md contract
	@uv run python3 scripts/bin/quality/check_agents_md_structure.py
...
infra-runtime-inventory: ## Print runtime inventory for active profile from contract/state
	@scripts/bin/infra/runtime_inventory.sh

infra-local-runtime-inventory: ## Print local runtime inventory from contract/state
	@scripts/bin/infra/local_runtime_inventory.sh
