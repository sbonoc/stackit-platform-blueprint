...
class VerticalSliceTests(unittest.TestCase):
    ...
    def test_help_lists_vertical_slice_targets(self) -> None:
        ...
        self.assertIn("quality-hooks-fast", result.stdout)
        self.assertIn("quality-hooks-strict", result.stdout)
        ...
        self.assertIn("quality-docs-check-module-contract-summaries-sync", result.stdout)
