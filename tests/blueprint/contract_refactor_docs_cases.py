...
class DocsRefactorCases(RefactorContractBase):
    ...
    def test_docs_readme_points_to_command_discovery(self) -> None:
        ...
        self.assertIn("make blueprint-install-codex-skill-sdd-step01-intake", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step02-resolve-questions", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step03-spec-complete", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step04-plan-slicer", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step05-implement", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step06-document-sync", docs_readme)
        self.assertIn("make blueprint-install-codex-skill-sdd-step07-pr-packager", docs_readme)
    ...
    def test_consumer_quickstart_mentions_status_snapshot_and_no_duplicate_smoke(self) -> None:
        ...
        self.assertIn("make blueprint-install-codex-skill-sdd-step01-intake", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step02-resolve-questions", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step03-spec-complete", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step04-plan-slicer", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step05-implement", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step06-document-sync", quickstart)
        self.assertIn("make blueprint-install-codex-skill-sdd-step07-pr-packager", quickstart)
    ...
    def test_ci_workflows_and_docs_exist(self) -> None:
        ...
        self.assertEqual(ci_workflow.count('uses: actions/checkout@v6'), 3)
