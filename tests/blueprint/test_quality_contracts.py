...
class QualityContractsTests(unittest.TestCase):
    ...
    def test_make_template_exposes_quality_docs_targets(self) -> None:
        ...
        self.assertIn("blueprint-install-codex-skill-sdd-intake-decompose", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-clarification-gate", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-plan-slicer", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-traceability-keeper", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-document-sync", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-pr-packager", make_template)
    ...
    def test_generated_makefile_exposes_quality_docs_targets(self) -> None:
        ...
        self.assertIn("blueprint-install-codex-skill-sdd-intake-decompose", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-clarification-gate", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-plan-slicer", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-traceability-keeper", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-document-sync", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-pr-packager", generated_make)
