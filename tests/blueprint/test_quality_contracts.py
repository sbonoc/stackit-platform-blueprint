...
class QualityContractsTests(unittest.TestCase):
    ...
    def test_make_template_exposes_quality_docs_targets(self) -> None:
        ...
        self.assertIn("blueprint-install-codex-skill-sdd-step03-resolve-questions", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-step04-spec-complete", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-step05-plan-slicer", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-step06-implement", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-step07-document-sync", make_template)
        self.assertIn("blueprint-install-codex-skill-sdd-step08-pr-packager", make_template)
    ...
    def test_generated_makefile_exposes_quality_docs_targets(self) -> None:
        ...
        self.assertIn("blueprint-install-codex-skill-sdd-step03-resolve-questions", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-step04-spec-complete", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-step05-plan-slicer", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-step06-implement", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-step07-document-sync", generated_make)
        self.assertIn("blueprint-install-codex-skill-sdd-step08-pr-packager", generated_make)
