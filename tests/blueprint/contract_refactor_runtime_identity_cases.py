...
class RuntimeIdentityRefactorCases(RefactorContractBase):
    ...
    def test_keycloak_runtime_reconcile_and_credentials_contract_hardening(self) -> None:
        ...
        langfuse_reconcile = _read("scripts/bin/infra/langfuse_keycloak_reconcile.sh")
        ...
        self.assertIn("keycloak_optional_module_reconcile_should_run()", keycloak_identity_contract)
        self.assertIn("keycloak_identity_contract_resolve_effective_realm_settings()", keycloak_identity_contract)
        self.assertIn("keycloak_csv_append_unique()", keycloak_identity_contract)
        self.assertIn("keycloak_optional_module_write_reconciled_state()", keycloak_identity_contract)
        ...
        self.assertIn("keycloak_optional_module_reconcile_should_run", workflows_reconcile)
        self.assertIn("keycloak_identity_contract_resolve_effective_realm_settings", workflows_reconcile)
        self.assertIn("keycloak_csv_append_unique", workflows_reconcile)
        self.assertIn("keycloak_optional_module_write_reconciled_state", workflows_reconcile)
        self.assertNotIn("csv_append_unique()", workflows_reconcile)
        self.assertIn("keycloak_optional_module_reconcile_should_run", langfuse_reconcile)
    ...
    def test_langfuse_postgres_neo4j_and_p0_modules_scaffolding_is_contract_conditional(self) -> None:
        ...
        self.assertIn("OPENSEARCH_ENABLED:", contract)
        ...
        self.assertIn("enable_flag: OPENSEARCH_ENABLED", contract)
        ...
        self.assertIn("if is_module_enabled opensearch; then", bootstrap)
