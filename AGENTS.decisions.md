...
- Epic #343 (Central Brain) reframing direction recorded 2026-06-22 as a `strawman-for-evaluation` proposal (NOT a ratified architecture decision):
  ...
  - Phase 0 evidence gate composed of two strands: (A) factory-observability signals owned by issue #378 under Epic #332 (re-litigation proxy + cross-reference distance + "didn't know that existed" survey — ship and emit independently of any Brain commitment), (B) two 1-week spikes owned by the gate itself (Backstage on STACKIT SKE + spec-as-KO-vs-separate-KO prototype). Calendar checkpoint **2026-09-22**; if criteria not met, EXPLICITLY hold and revisit at 2026-12-22 or sooner.
