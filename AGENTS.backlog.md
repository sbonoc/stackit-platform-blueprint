...
- [ ] **FUTURE (Factory — Epic #343 reframing, blocked_by: Epic #332 100% stable + Epic #343 promotion)** Epic #343 reframing — introduce Knowledge Objects (Contract C9), Knowledge Compiler component, LLM-Wiki projection pattern, and federation principle to evolve Epic #343 from "graph + vector knowledge layer" into "Enterprise Knowledge Fabric." Preserve all existing #343 Phase 0 locked decisions; preserve all C1–C8 contracts; preserve anti-dual-write. **Canonical strategic-decision doc (repo-tracked, normative for the intake):** `docs/blueprint/proposals/2026-06-22-epic-343-knowledge-fabric-reframing.md` — read this end-to-end before drafting the intake; it carries the 4-axis evaluation, recommended + alternative architectures, three soft tensions, C7→KO field mappings, locked invariants, and concrete next-step instructions. Source brief: user-supplied "Enterprise Knowledge Fabric Amendment Brief" (2026-06-22), retained externally by the user and cited in the proposal doc's § Provenance. Do NOT pick up until both pre-conditions met. — https://github.com/sbonoc/stackit-platform-blueprint/issues/343
