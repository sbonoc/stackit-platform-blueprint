...
- [ ] **FUTURE (Factory — Epic #343 reframing, blocked_by: Epic #332 100% stable + Epic #343 promotion)** Epic #343 reframing — introduce Knowledge Objects (Contract C9), Knowledge Compiler component, LLM-Wiki projection pattern, and federation principle to evolve Epic #343 from "graph + vector knowledge layer" into "Enterprise Knowledge Fabric." Preserve all existing #343 Phase 0 locked decisions; preserve all C1–C8 contracts; preserve anti-dual-write. Source: user-supplied Enterprise Knowledge Fabric Amendment Brief (2026-06-22); strategic decision recorded in memory `project_central_brain_knowledge_fabric_reframing.md`. Intake author MUST copy the brief into `specs/<intake-date>-epic-343-knowledge-fabric-reframing/context_pack.md` at intake time, then read [[project-central-brain-knowledge-fabric-reframing]] for the 4-axis evaluation, recommended architecture, three soft tensions, C7→KO field mappings, and invariants to preserve. Do NOT pick up until both pre-conditions met. — https://github.com/sbonoc/stackit-platform-blueprint/issues/343
