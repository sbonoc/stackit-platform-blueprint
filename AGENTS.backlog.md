...
## Current Priorities
- [ ] P1 (Platform modules — first-class): Issue #248 — Object-storage module dual-lane implementation (MinIO local + STACKIT Terraform). **In Progress**: `specs/2026-05-06-issue-248-object-storage-module/`, PR #250. Plan: 5 slices (RED tests → Terraform module → Secret credentials → Contract/docs → Quality gates). `SPEC_READY: true`.
