...
- [x] (in-progress) proposal(issue-265-271-conflict-resolution-ux): Option B — source-exists inference for blueprint-managed catch-all; if `source_exists=True` and ownership is `blueprint-managed`, infer `take_source` instead of `human_required`
      ...
      **In progress**: `specs/2026-05-13-issue-265-271-source-exists-inference/`
