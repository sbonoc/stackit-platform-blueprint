...
- [x] T-006 Verify `artifacts/infra/rendered/opensearch.values.yaml` includes both keys via pass-through rendering (artifact is runtime-generated by `opensearch_render_values_file()`; static YAML keys pass through unchanged — no committed-file edit)
