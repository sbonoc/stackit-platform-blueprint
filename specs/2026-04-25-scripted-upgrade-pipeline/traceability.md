...
|---|---|---|---|---|---|---|
| FR-001 | SDD-C-005 | Stage 1 pre-flight: dirty-tree abort | `scripts/bin/blueprint/upgrade_consumer.sh` Stage 1 | `tests/blueprint/test_upgrade_pipeline.py::TestPreflightDirtyTree` | `architecture.md § Stage 1`, `plan.md § Slice 1` | `upgrade-residual.md` abort message |
| FR-002 | SDD-C-005 | Stage 1 pre-flight: unresolved ref abort | `scripts/bin/blueprint/upgrade_consumer.sh` Stage 1 | `tests/blueprint/test_upgrade_pipeline.py::TestPreflightInvalidRef` | `architecture.md § Stage 1`, `plan.md § Slice 1` | `upgrade-residual.md` abort message |
| FR-003 | SDD-C-005 | Stage 1 pre-flight: bad contract abort | `scripts/bin/blueprint/upgrade_consumer.sh` Stage 1 | `tests/blueprint/test_upgrade_pipeline.py::TestPreflightBadContract` | `architecture.md § Stage 1`, `plan.md § Slice 1` | `upgrade-residual.md` abort message |
