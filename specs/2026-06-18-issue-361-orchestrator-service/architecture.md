...
- **Domain layer (Context A):**
  ...
  - `PredicateRegistry` — typed predicate evaluator (FR-012); the first predicate ships is `has-user-facing-flow + diff-touches-frontend-paths` (gating `usability-pragmatist`).
