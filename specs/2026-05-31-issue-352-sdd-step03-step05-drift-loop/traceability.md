...
- Follow-up 1: If real-world adoption of FR-004 (AC authoring rule) is poor after ≥5 work items, promote to a machine-enforced regex check per ADR D-7 revisit clause.
