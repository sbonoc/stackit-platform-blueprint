...
| FR-003 | SDD-C-011 | Format documentation update | `docs/platform/consumer/runtime_credentials_eso.md`; `scripts/templates/blueprint/bootstrap/docs/platform/consumer/runtime_credentials_eso.md`; `docs/platform/consumer/troubleshooting.md`; `scripts/templates/blueprint/bootstrap/docs/platform/consumer/troubleshooting.md` | `make docs-build && make docs-smoke` — PASS | all four doc files updated | none |
...
- Follow-up 2: ~~`docs/platform/consumer/troubleshooting.md` usage examples for `RUNTIME_CREDENTIALS_SOURCE_SECRET_LITERALS` may also reference comma-separated format~~ — **resolved**: updated in Document phase (line 528 in both source and bootstrap template copy).
