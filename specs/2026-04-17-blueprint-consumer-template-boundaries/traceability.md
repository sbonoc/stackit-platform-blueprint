...
| FR-002 | SDD-C-005, SDD-C-021 | Initial-mode-only prune helper wired into consumer seed flow | `scripts/lib/blueprint/init_repo_contract.py` | `tests/blueprint/test_quality_contracts.py::test_init_repo_source_artifact_prune_globs_apply_only_on_initial_mode` | `AGENTS.decisions.md` | `make quality-hooks-run`; `make infra-validate` |
...
| NFR-SEC-001 | SDD-C-009 | Contract-bounded prune scope | `scripts/lib/blueprint/contract_schema.py`; `scripts/lib/blueprint/init_repo_contract.py` | `tests/blueprint/test_quality_contracts.py::test_init_repo_source_artifact_prune_globs_apply_only_on_initial_mode` | `AGENTS.decisions.md` | `make infra-validate` |
...
| AC-002 | SDD-C-012 | Generated-consumer mode preserves matched paths | `scripts/lib/blueprint/init_repo_contract.py` | `tests/blueprint/test_quality_contracts.py::test_init_repo_source_artifact_prune_globs_apply_only_on_initial_mode` | `spec.md` acceptance criteria section | `make infra-validate` |
...
- Follow-up 1: externalize docs allowlist path set into contract metadata to avoid dual maintenance between contract and sync utility.
