...
- [ ] G-002 Confirm open questions count = 0 (Q-1 nameservers, Q-2 DNSSEC must be resolved)
...
- [ ] T-007 Write failing `test_contract.py` assertions for AC-005, AC-006, AC-009, AC-010:
      ...
      Run pytest — confirm AC-005, AC-006 fail
...
## Test Automation
- [ ] T-101 `tests/infra/modules/dns/test_contract.py` written (T-001, T-007) and passing (T-009) — ≥ 10 assertions
