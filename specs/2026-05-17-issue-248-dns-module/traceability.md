...
| NFR-OBS-001 | SDD-C-010 | — | zone_id, zone_name, zone_fqdn in state; smoke validates all three non-empty | `dns_smoke.sh` + `dns_apply.sh` | AC-005, AC-006 smoke checks | n/a | n/a |
