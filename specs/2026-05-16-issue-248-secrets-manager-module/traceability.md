...
| FR-007 | SDD-C-005, SDD-C-009 | — | `secrets_manager_reconcile_runtime_secret()` | `scripts/lib/infra/secrets_manager.sh` | AC-008: test_contract.py assertion | n/a | n/a |
...
| AC-008 | SDD-C-012 | — | secrets_manager_reconcile_runtime_secret() writes blueprint-secrets-manager-auth | test_contract.py | pytest PASS | — | n/a |
