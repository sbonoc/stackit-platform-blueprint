...
- Excluded item 3: provisioning the factory bot GitHub account, scoping its PAT, creating the Confidential K8s cluster, configuring ESO + Secrets Manager, or applying the egress allowlist — owned by #334.
