...
- [x] T-010 Update `docs/blueprint/governance/ownership_matrix.md` (or equivalent) with normative taxonomy rule for `tests/blueprint/` vs `tests/infra/`
- [x] T-011 Run `python3 scripts/lib/docs/sync_blueprint_template_docs.py` — sync to bootstrap template mirrors
- [x] T-012 Run `make quality-docs-check-changed` — confirm PASS

## Accessibility Testing (Normative — N/A)
- [x] T-A01 N/A — blueprint tooling only; no UI components (NFR-A11Y-001)
...
- [x] T-203 Confirm `required_seed_files` count is reduced vs pre-change baseline
