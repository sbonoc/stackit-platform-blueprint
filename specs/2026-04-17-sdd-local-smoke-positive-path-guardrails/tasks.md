...
- [x] T-002 Update SDD templates and mirrored consumer-init assets
- [x] T-003 Update blueprint docs/assistant interoperability artifacts
- [x] T-004 Update control-catalog source/render artifacts
...
- [x] T-104 Any reproducible pre-PR smoke/`curl` finding MUST be translated into a failing automated test first, then fixed to green in the same work item, or explicitly documented as deterministic-exception in publish artifacts
