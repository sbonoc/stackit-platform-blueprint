...
| FR-004 | SDD-C-005, SDD-C-010 | N/A | ADR §6 (verdict schema) | ADR-issue-364 §6 (embedded JSON Schema) | `pr_context.md` AC-002 + schema-validity script | ADR-issue-364 §6 | C7 `outcome_details.expert_verdicts[]` post-merge |
