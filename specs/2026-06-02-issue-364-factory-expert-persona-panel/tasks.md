...
- [ ] T-003 Re-home 10 skill runbooks from PR #362 onto this branch with persona-coupling language stripped (FR-006 a, b); reshape `blueprint-agent-pr-review/SKILL.md` to take panel-input and emit a per-expert verdict array (FR-006 c).
