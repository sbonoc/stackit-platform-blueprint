...
start_script_metric_trap "infra_opensearch_destroy"

opensearch_init_env
resolve_optional_module_execution "opensearch" "destroy"
...
remove_state_files_by_prefix "opensearch_"
state_file="$(write_state_file "opensearch_destroy" \
...
log_info "opensearch artifacts destroyed"
log_info "opensearch destroy state written to $state_file"
