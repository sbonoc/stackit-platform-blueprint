...
if is_stackit_profile; then
  ...
  run_cmd env DNS_ENABLED=false "$ROOT_DIR/scripts/bin/infra/stackit_foundation_preflight.sh"
  run_cmd env DNS_ENABLED=false "$ROOT_DIR/scripts/bin/infra/stackit_foundation_apply.sh"
