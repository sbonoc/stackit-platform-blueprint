...
(
  ...
  run_cmd env BLUEPRINT_CODEX_SKILLS_DIR="$tmp_root/codex-skills" make blueprint-install-codex-skills
  ...
  run_cmd test -f "$tmp_root/codex-skills/blueprint-consumer-ops/SKILL.md"
  run_cmd test -f "$tmp_root/codex-skills/blueprint-consumer-ops/references/consumer_ops_checklist.md"
