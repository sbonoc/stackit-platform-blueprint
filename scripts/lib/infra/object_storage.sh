...
object_storage_init_env() {
  ...
  set_default_env OBJECT_STORAGE_IMAGE_REPOSITORY "$OBJECT_STORAGE_LOCAL_IMAGE_REPOSITORY"
  set_default_env OBJECT_STORAGE_IMAGE_TAG "$OBJECT_STORAGE_LOCAL_IMAGE_TAG"
  set_default_env OBJECT_STORAGE_CLIENT_IMAGE_REGISTRY "$OBJECT_STORAGE_LOCAL_CLIENT_IMAGE_REGISTRY"
