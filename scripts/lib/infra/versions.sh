...
MANAGED_CACHE_REDIS_HELM_CHART_VERSION_PIN="25.5.3"
OPENSEARCH_HELM_CHART_VERSION_PIN="1.6.3"
...
POSTGRES_LOCAL_IMAGE_TAG="17.6.0-debian-12-r4"
...
OPENSEARCH_LOCAL_IMAGE_TAG="2.19.1-debian-12-r4"
